...
4. Maintain internal state via vigil.store for trend analysis
5. Use vigil.log to record observations and decisions
6. Adapt behavior based on historical data

Pattern: loop { observe → analyze → decide → act → sleep }
Use vigil.sleep() between cycles (recommended: 30-60 seconds minimum).`,
