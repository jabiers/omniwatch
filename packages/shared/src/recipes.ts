...
export const BUILT_IN_RECIPES: AgentRecipe[] = [
  {
    ...
    category: 'finance',
    prompt: 'Monitor Bitcoin price from CoinGecko API. Check every 5 minutes. Notify me when the price changes by more than 3% from the last notified price. Include current price and percentage change in the notification.',
  ...
  },
  {
    ...
    category: 'finance',
    prompt: 'Monitor Ethereum gas prices using a public API. Notify me when gas fees drop below 20 gwei. Check every 2 minutes.',
  ...
  },
  {
    ...
    category: 'monitoring',
    prompt: 'Monitor the health of a website. Check every minute. Notify me if the site is down (non-200 status or timeout >10s). Include response time in each check log.',
  ...
  },
  {
    ...
    category: 'security',
    prompt: 'Check the SSL certificate expiration date of a website. Notify me when the certificate expires within 14 days. Check once per day.',
  ...
  },
  {
    ...
    category: 'devops',
    prompt: 'Monitor a GitHub repository for new releases using the GitHub API (no auth required for public repos). Check every 15 minutes. Notify me when a new release is published with the version number and release notes.',
  ...
  },
  {
    ...
    category: 'devops',
    prompt: 'Monitor one or more npm packages for new version releases using the npm registry API. Check every hour. Notify me when a new version is published.',
  ...
  },
  {
    ...
    category: 'data',
    prompt: 'Monitor an RSS feed for new items. Check every 10 minutes. Notify me when new articles are published. Include the title and link in the notification.',
  ...
  },
  {
    ...
    category: 'devops',
    prompt: 'Monitor a REST API endpoint. Check every 2 minutes. Verify the response status is 200 and the response body contains expected fields. Notify me on failures with error details.',
  ...
  },
  {
    ...
    category: 'devops',
    prompt: 'Monitor a Docker Hub repository for new image tags. Check every 30 minutes. Notify me when a new tag is pushed. Use the Docker Hub API v2.',
  ...
  },
  {
    ...
    category: 'social',
    prompt: 'Monitor Hacker News for trending stories using the HN API. Check every 15 minutes. Notify me about stories that reach 200+ points. Include title, URL, and score.',
    config: { interval: 900_000 },
  ...
  },
  {
    ...
    category: 'finance',
    prompt: 'Monitor USD/KRW exchange rate using a free API. Check every 30 minutes. Notify me when the rate changes by more than 1% from the last notified rate.',
    config: { interval: 1_800_000 },
  ...
  },
  {
    ...
    category: 'monitoring',
    prompt: 'Monitor disk usage by checking available space. Use omni.fetch to call a local endpoint or system command wrapper. Notify me when any partition exceeds 85% usage. Check every 5 minutes.',
